...
/**
 * Generates the service for defined interface of type on user information.
...
public class UserServiceGenerator {
    private static final String API_BASE_URL = "http://userservice.app.veery.cloud/";
    ...
    /**
     * User service generator public interface to create a service class
